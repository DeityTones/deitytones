      ...
      <div className="relative z-10 pt-32 pb-16 px-4 flex-grow">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-300 mb-16 text-lg">
            Stream my latest releases across all major platforms.
          </p>
          ...
          <div className="bg-black/40 backdrop-blur-md p-8 rounded-2xl 
                          border border-white/10 shadow-2xl mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center">
              ...
              <div className="md:col-span-1 w-full aspect-square 
                              bg-gradient-to-br from-[#4c4c8e] to-black 
                              rounded-xl border border-white/20 
                              flex items-center justify-center 
                              shadow-lg relative overflow-hidden">
                <span className="text-white/50 font-bold tracking-widest">
                  ALBUM ART
                </span>
              </div>
              ...
              <div className="md:col-span-2">
                <h3 className="text-2xl font-bold text-[#E5B868] mb-2">
                  Track Title Goes Here
                </h3>
                <p className="text-gray-300 mb-6">
                  Produced & Mixed by DeityTones
                </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {streamingPlatforms.map((platform) => (
                <a
                  ...
                  className={`${platform.color} w-full md:w-48 text-white p-6 
                              rounded-xl text-center hover:opacity-90 
